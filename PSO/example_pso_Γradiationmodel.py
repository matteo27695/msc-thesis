...
if __name__ == '__main__':
    ...
    #dates = [dates[i] for i in index_list]
    volumes = dictpatients[patient]["volumes"]
    #volumes = [volumes[i] for i in index_list]
    ...
    #append_list_as_row("performances-LQmodel.csv", field_names)
    append_dict_as_row("performances-LQmodel.csv", performance, field_names)
    ...
    plt.ylabel('Global Best RSS Value')
    plt.title("RSS over iterations")
    plt.grid(True)
    plt.show()
